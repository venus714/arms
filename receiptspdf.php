<?php
	...
	$sql3 = "select trans_date,housecode,tenant,plotname,pcode,paid,recptno from recptitem";
	...
	<hr>
	<br><br>
	<p class="txt1">Payments Posted betweem  '.$date1.' and '.$date2.'</p><br><br>
	<table><thead style="display: table-header-group">';
	
	
	$html.='<tr class="summary"><th>Date Recpted</th><th>Unit No</th><th class="centre">Property</th>
	<th class="centre">Tenant</th><th class="left">Recpt No</th><th class="left">Pay Code</th> <th class="right">Paid</th> </tr></thead>';
	...
	<td class="left">'.$tenant.'</td><td class="left">'.$recptno.'</td><td class="left">'.$pcode.'</td> <td class="right">'.$paid.'</td></tr>';
	}
	$zow = $qry4->fetch_assoc();
	$zpaid= number_format($zow['paid'],2);
	$html.='<tr class="summary"><th colspan=6>Total Paid</th><th class="right">'.$zpaid.'</th></tr>
	</table>
	</body></html>';
	...
	$dompdf->render();
	$dompdf->stream('recptdtls',array("attachement"=>0));
	?>