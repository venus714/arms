...
<div class='middle'>
<h3 class='header'> Transfer Tenant</h3>
<div class='mypara'>
<form method ='post'>
<table>
...
function writedata()
{
	...
	var houseid1= document.getElementById("hseid1").value;
	var houseid2= document.getElementById("hseid2").value;
	var housecode1= document.getElementById("hsecode1").value;
	var housecode2= document.getElementById("hsecode2").value;
	var tenantcode= document.getElementById("tntcode").value;
	var tenant= document.getElementById("tenant").value;
	var dtrans= document.getElementById("dtrans").value;
	var oldrent= document.getElementById("rent").value;
	var newrent= document.getElementById("newrent").value;
	...
	var formdata = 'housecode1='+ housecode1 +'&housecode2='+ housecode2 +'&houseid1='+ houseid1 + '&dtrans='+dtrans+
	'&houseid2='+houseid2+ '&tenantcode='+tenantcode +'&plotcode='+plotcode +'&tenant='+tenant+'&oldrent='+oldrent + '&newrent='+newrent;
	
	// AJAX code to submit form.
	$.ajax({
		 type: "POST",
		 url: "tntransfer.php", //call storeemdata.php to store form data
		 data: formdata,
		 cache: false,
		 		 		 });
			}	 
...
function zdisplay(str) {
  ...
  xhttp.open("GET", "transferdtls.php?q="+str);
  xhttp.send();
}
</script>
