...
<div class='middle'>
<h3 class='header'> Opening Deposits</h3>
<div class='mypara'>
<form method ='post'>
<table>
...
function writedata()
{
	...
	$.ajax({
		 type: "POST",
		 url: "deposave.php", //call storeemdata.php to store form data
		 data: formdata,
		 cache: false,
		 		 		 });
			}	 
...
function showhse(str) {
  ...
  xhttp.open("GET", "getenant1.php?q="+str);
  xhttp.send();
}
</script>
...
function zdisplay(str) {
  ...
  xhttp.open("GET", "depodtls.php?q="+str);
  xhttp.send();
}
</script>
