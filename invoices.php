...
<div class='middle'>
<h4 class='header'>Generate Invoices</h4>
<div id='msg'></div>
<div class='mypara'>
...
<th><input type='checkbox' name='chk1' id='chk1' value='' onclick='enableunits()' disabled>One Unit</th>
<td><div id='hsehint'>
...
function generate() {
	...
	var frmdata ='plotcode='+plotcode + '&nmonth='+nmonth + '&nyear=' +nyear+'&check='+check+'&tenantcode='+tenantcode;
	//alert(frmdata)
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "geninv.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
