...
<div class='middle1'>
<h4 class='header'>Previw/Print Receipts Banked</h4>
<!--<div id='msg'></div>-->
<div class='mypara'>
<form method='POST' action='recptdepdf.php' autocomplete='off'>
...
<script>
		...
		$.ajax({
			method: 'post',
			url: 'recptdepos.php',
			data: {'plotcode':plotcode,'date1': date1,'date2': date2,'opt': opt},
			dataType: "text",
