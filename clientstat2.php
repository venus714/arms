...
$remit1 = "select rdate,chequeno,clerk,statype from remittance where plotcode='$plotcode' and rdate='$rdate' and pcode='$pcode'";
...
and pcode IN ('DEP','EDP','WDP') and canx !='1' and remitted='1' and dremit = '$rdate' ";
