...
<div class='middle3'>
<h4 class='header'>Remitted Rent Statement</h4>
<div id='msg'></div>
<div class='mypara'>
...
function generate() {
	...
	var nmonth = document.getElementById("nmonth").value;
	var nyear = document.getElementById("nyear").value;
	var frmdata ='plotcode='+plotcode + '&rdate='+ rdate + '&nmonth='+nmonth + '&nyear='+nyear;
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "clientstat2.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
		success: function(data) {
