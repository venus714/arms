...
<div class='sidebar'>
<div class='mypara'>
<h3 class='hz'>Amend Bank Expenses</h3>
<table>
...
if (refno==''){
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "bnkedit.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
...
function updatedata()
{
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "bnkupdate.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
		success: function(data) {
...
<div class='middlebar'>
<div class='mypara'>
<h3 class='hz'>Add Bank Expenses</h3>
<table>
...
<tr><th> Amount</th>
<td><input type='text' name='adv' id='adv' value='' readonly></td></tr>
<tr><th> Narrative</th>
...
if (plotcode==''){
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "bnkexpsave.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
		success: function(data) {
...
<div class='sidebar'>
<div class='mypara'>
<h3 class='hz'>Display Bank Charges</h3>
<table>
<tr><th>Property Name</th>
...
function display()
{
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "bnkexpop.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
		success: function(data) {
