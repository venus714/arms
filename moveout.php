...
<div class='middle'>
<h3 class='header'> Vacate Tenant </h3>
<div class='mypara'>
<form method ='post'>
<table>
...
function writedata()
{
	...
	if (dateout == '' ) {
		...
		'&plotcode='+plotcode + '&rent=' + rent +'&housecode=' +housecode;
	// AJAX code to submit form.
	$.ajax({
		 type: "POST",
		 url: "tenantout.php", //call storeemdata.php to store form data
		 data: formdata,
		 cache: false,
		 		 		 });
			}	 
...
function zdisplay(str) {
  ...
  xhttp.open("GET", "tenantdtls.php?q="+str);
  xhttp.send();
}
</script>
