...
<div class='middle'>
<h4 class='header'>Delete Bill</h4>
<div id='msg'></div>
<div class='mypara'>
...
<tr>
<th></th>
<td><button type='button' name='ok' id='ok' onclick='delbill()'>Delete</button></td>
...
function delbill() {
	...
	}else
	{
		$.ajax({
		 type: "POST",
		 url: "delemont.php", //call storeemdata.php to store form data
		 data: frmdata,
		 cache: false,
		 dataType: "text",
