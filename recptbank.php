...
//$conn = new mysqli(DB_SERVER, DB_USER, DB_PASS, DBASE);
	...
	if ($opt=='1')
	{
	$sql1 = "create or replace view recpts as select * from receipts where plotcode='$plotcode' and accno='$accno' 
	and depdate between '$date1' and '$date2'";
	$sql2 = $conn->query($sql1);
	} else {
	$sql1 = "create or replace view recpts as select * from receipts where depdate between '$date1' and '$date2' and accno = '$accno'";
	$sql2 = $conn->query($sql1);
	}
