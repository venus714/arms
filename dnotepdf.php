<?php
	...
	$sql1 = "select tenant,housecode,tenantcode, arrears from dnsumm";
	...
	$qr1 = "select pcode,description,arrears from dbnote where tenantcode='$tenantcode'";
	$qr2 = $conn->query($qr1);
	$html.='<table>
	<tr><th class="hz1">Pay code</th><th class="hz1">Description</th><th class="right">Arrears</th></tr>';
	...
	$html.='<tr><td class="hz1">'.$pcode.'</td><td class="hz1">'.$description.'</td><td class="right">'.$arrears.'</td></tr>';
	}
	$html.='<tr><td></td><td class="hz1">Total Due</td><td class="right">'.$zarrears.'</td></tr>';
