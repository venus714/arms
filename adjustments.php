...
<div class='middle'>
<h3 class='header'> Adjust Balances</h3>
<div class='mypara'>
<form method ='post'>
<table>
...
function writedata()
{
	...
	'&mdate='+mdate + '&reason='+reason + '&authority='+authority;
	...
	$.ajax({
		 type: "POST",
		 url: "adjsave.php", //call storeemdata.php to store form data
		 data: formdata,
		 cache: false,
		 		 		 });
			}	 
...
function zdisplay(str) {
  ...
  xhttp.open("GET", "tntdtls.php?q="+str);
  xhttp.send();
}
</script>
