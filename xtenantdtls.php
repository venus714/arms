...
echo "<td><input type='text' name='dateout' id='dateout' value='$dateout' readonly></td>";
echo "<th>Date Reversed</th>";
echo "<td><input type='text' name='daterev' id='daterev' value='$daterev'></td>";
echo "</tr>";
echo "<th></th>";
echo "<td><button type='button' name='save' id='save'  onclick='writedata()'>Reverse MoveOut</button></td>";
